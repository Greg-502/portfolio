...
export default function Skills() {
    ...
    return(
        <motion.section 
            ...
            id="skills" className='text-gray-800 items-center flex justify-center min-h-full lg:min-h-screen px-6 md:px-0 flex-col py-10 md:py-0'>
            <div className="w-full md:bg-yellow-300 md:px-28 md:py-10 grid md:grid-cols-3 gap-10 md:justify-evenly">
                <div>
