...
function Projects() {
    return(
        <div id="projects" className='text-left text-gray-900 bg-white flex justify-center items-center min-h-full lg:min-h-screen px-6 md:px-2 flex-col py-10 md:py-0'>
